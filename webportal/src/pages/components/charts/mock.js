...
export const chartData = {
  apex: {
    column: {
      ...
      options: {
        ...
        xaxis: {
          categories: ['New York', 'California', 'North Carolina', 'Washington', 'Florida', 'Texas', 'New Jersey', 'Georgia'],
          labels: {
            style: {
              colors: columnColors,
              fontSize: '14px'
  ...
  echarts: {
    line: {
      ...
      legend: {
        data: ['2020 Infected', '2021 Infected'],
        textStyle: {
          color: colors.textColor
        }
      },
          ...
          axisPointer: {
            label: {
              formatter: function (params) {
                return 'Infected  ' + params.value
                  + (params.seriesData.length ? '：' + params.seriesData[0].data : '');
              }
            }
          },
          data: ["2020-03", "2020-04", "2020-05", "2020-06", "2020-07", "2020-08", "2020-09", "2020-10", "2020-11", "2020-12", "2021-1", "2021-2"]
        },
        {
          type: 'category',
          axisTick: {
